...
namespace MsgPassingCommunication
{
	...
	{
		if (csMsg->attributes->ContainsKey("setPaths"))
		{
			pComm->setSendFilePath(Sutils::MtoNstr(csMsg->value("sendFilePath")));
			pComm->setSaveFilePath(Sutils::MtoNstr(csMsg->value("saveFilePath")));
		}
		if (csMsg->attributes->ContainsKey("stop"))
		{
			pComm->stop();
		}
